...
const CaptureView = styled(Reanimated.View)`
    flex: 1;
`;

const ShadowView = styled(Reanimated.View)`
    position: absolute;
    width: ${CAPTURE_BUTTON_SIZE}px;
    height: ${CAPTURE_BUTTON_SIZE}px;
    border-radius: ${CAPTURE_BUTTON_SIZE / 2}px;
    background-color: #e34077;
`;

const StyledButton = styled.View`
    width: ${CAPTURE_BUTTON_SIZE}px;
    height: ${CAPTURE_BUTTON_SIZE}px;
    borderRadius: ${CAPTURE_BUTTON_SIZE / 2}px;
